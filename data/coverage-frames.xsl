...
<!--
 ...
 @author François Poirotte <a href="mailto:clicky@erebot.net"/>
...
Generated for PLOP
<!--<xsl:value-of select="$phing.project.name"/> using <xsl:value-of select="$phing.version"/>-->
        </td>
        </tr>
  </table>
    <hr size="1"/>
