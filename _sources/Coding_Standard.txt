...
This page contains documentation on the coding standard used for Plop's
...
Plop does not have a hard standard for the use of single quotes vs.
...
..  note::
    For code that is part of Plop itself, you don't need to manually include
...
Plop coding standards require them, even at the end of code blocks.
...
..  table:: Class/interface name to filesystem mapping
    ...
    +===========================+===========================================+
    | Plop                      | :samp:`{src}/Plop.php`                    |
    +---------------------------+-------------------------------------------+
    | Plop_Logger               | :samp:`{src}/Plop/Logger.php`             |
    +---------------------------+-------------------------------------------+
    | Plop_LoggerInterface      | :samp:`{src}/Plop/Logger/Interface.php`   |
    +---------------------------+-------------------------------------------+

This convention is required to make Plop's autoloader work.

Classes and interfaces
~~~~~~~~~~~~~~~~~~~~~~

Classes and interface should be named using "UpperCamelCase", a newline
should be inserted before the ``extends`` and ``implements`` keywords
...
:samp:`Plop_Handler_{HandlerName}`.
...
..  sourcecode:: php
    ...
    <?php
        class Foo
        {
            // This is valid PHP code, and it is accepted in Plop.
            final static public function foo()
            {
                ...
            }

            // This is valid PHP code, and it is also accepted in Plop.
            static final public function bar()
            {
                ...
            }

            // This is valid PHP code, but it is forbidden in Plop's code.
...
*   Global constants defined by handlers should also have their names prefixed
    by an uppercase spelling of the handler that defines them.
...
Global variables are strictly forbidden in Plop; this is non-negociable.
